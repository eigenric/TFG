...
La metodología se basa en una sólida **fundamentación teórica en matemáticas:** álgebra lineal,  métodos numéricos, análisis, probabilidad y estadística; y **aprendizaje profundo (deep learning)**, complementada con un estudio del estado del arte en imputación. En la parte práctica, se ha elaborado un [Jupyter Notebook](https://github.com/eigenric/TFG/blob/main/notebooks/Notebook_Imputation.ipynb) y un paquete de Python, [pampaneira\_imputation](https://github.com/eigenric/TFG/tree/main/pampaneira_imputation), que integra diversos métodos de imputación, desde elementales hasta Transformer y SAITS. El flujo experimental incluye preprocesamiento y generación controlada de ausencias para una evaluación rigurosa.
