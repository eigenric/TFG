...
implementado en la región de Poqueira, en la Alpujarra granadina \cite{smartpoqueira_project}.
...
datos, y \textit{Pypots} para el entrenamiento de los modelos \textit{Transformers}.

\subsection{Bibliografía Fundamental}

Para la elaboración del Capítulo 3, Teoría del Aprendizaje Estadístico se ha
destacamos el uso del libro Learning from Data \cite{abu-mostafa_learning_2012}.
...
modelos generativos, específicamente utilizando arquitecturas Transformer.
...
\subsection{Parte de Informática}
    ...
    \begin{enumerate}
        \item  \textbf{Definir la arquitectura Transformer. Modelo SAITS} 
        Definir Encoder, Decoder, FFN, mecanismo de atención y 
        como la arquitectura transformers los combina.

        \item \textbf{Descripción de los conjuntos de datos. EDA} 
        Llevar a cabo una descripción del conjunto de dato obtenido del sistema
        IoT de detección de vehículos. Realizar un análisis exploratorio de los datos.
        
        \item \textbf{Entrenamiento mediante la biblioteca PyPOTS. Rendimiento}
...
El objetivo 1 de Informática se abordará en el Capítulo 3, el objetivo 2 en el Capítulo 4 y el objetivo 3 en el
Capítulo 5. 
