...
\usepackage{natbib}
\usepackage{pdfpages}
\usepackage{siunitx} % Para alinear números en columnas y manejar unidades/formato
...
\input{chapters/anexos.tex} % Incluye el contenido del archivo anexos.tex aquí
% --- FIN DE LA INCLUSIÓN DE LOS ANEXOS ---
...
% Or insert specific pages (e.g., 1 to 3)
% \includepdf[pages=1-3]{yourfile.pdf}
